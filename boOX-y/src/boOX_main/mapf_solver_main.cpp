...
/*                                                                            */
/*============================================================================*/
/* mapf_solver_main.cpp / 2-147_planck                                        */
/*----------------------------------------------------------------------------*/
//
...
#include "boOX_core/boOX_cnf.h"
#include "boOX_core/boOX_smtcbs.h"
#include "boOX_util/boOX_statistics.h"

#include "boOX_main/boOX_mapf_solver_main.h"
...
/*----------------------------------------------------------------------------*/
	...
	if (!parameters.m_input_filename.empty())
	{
	    ...
	    if (sFAILED(result))
	    {
		printf("Error: Failed to open multi-agent path finding instance %s (code = %d).\n", parameters.m_input_filename.c_str(), result);
		return result;
	    }
	}
